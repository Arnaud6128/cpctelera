...
#################
# PACKZX1: Creates a compressed file out of all the files previously added with ADD2PACK,
# using ZX1 compression method. Updates IMGASMFILES and OBJS2CLEAN adding new C files
# that result from the pack generation.
#
# $(1): Compressed pack file name
# $(2): Output folder for generated files
...
define PACKZX1
	...
	$(eval _A := $(strip $(3)))
	$(if $(_A)\
		, $(call ENSURE_ADDRESS_VALID,$(_A),PACKZX1) \
		  $(eval _A := -org $(_A)) \
	)
...
$(PACK_$(1)_target): $(PACK_$(1)) $(A2P_DEPEND)
	@$(call PRINT,$(PROJNAME),"Compressing files to generate $(PACK_$(1)_outfile)...")
	$(CPCTPACK) $(A2P_OPTS) -c zx1 $(_A) $(PACK_$(1)_outfile) $(PACK_$(1))
...
#################
# PACKZX1B: Creates a compressed file out of all the files previously added with ADD2PACK,
# using ZX1 Backwards compression method. Updates IMGASMFILES and OBJS2CLEAN adding new C
# files that result from the pack generation.
#
# $(1): Compressed pack file name
# $(2): Output folder for generated files
...
define PACKZX1B
	...
	$(eval _A := $(strip $(3)))
	$(if $(_A)\
		, $(call ENSURE_ADDRESS_VALID,$(_A),PACKZX1B) \
		  $(eval _A := -org $(_A)) \
	)
...
$(PACK_$(1)_target): $(PACK_$(1)) $(A2P_DEPEND)
	@$(call PRINT,$(PROJNAME),"Compressing files to generate $(PACK_$(1)_outfile)...")
	$(CPCTPACK) $(A2P_OPTS) -c zx1b $(_A) $(PACK_$(1)_outfile) $(PACK_$(1))
...
#################
# PACKRLEWB: Creates a compressed file out of all the files previously added with ADD2PACK,
# using RLE WonderBoy compression method. Updates IMGASMFILES and OBJS2CLEAN adding new C
# files that result from the pack generation.
#
# $(1): Compressed pack file name
# $(2): Output folder for generated files
...
$(PACK_$(1)_target): $(PACK_$(1)) $(A2P_DEPEND)
	@$(call PRINT,$(PROJNAME),"Compressing files to generate $(PACK_$(1)_outfile)...")
	$(CPCTPACK) $(A2P_OPTS) -c rlewb $(_A) $(PACK_$(1)_outfile) $(PACK_$(1))
