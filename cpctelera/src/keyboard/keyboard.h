...
extern void cpct_scanKeyboard_i   (void);
extern void cpct_scanKeyboard_f   (void);
extern void cpct_scanKeyboard_if  (void);
...
extern   u8 cpct_getKeypressedAsASCII(void); // Function old name for compatibility with old code
