...
// RLEWB functions
extern u16  cpct_rlewb_compress   (u8* dest, u8* src, u16 length)   __z88dk_callee;
extern void cpct_rlewb_decrunch   (u8* dest, u8* src)               __z88dk_callee;
extern void cpct_rlewb_drawSprite (u8* sprite, u8* vmem, u16 width) __z88dk_callee;
