...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: cpct_drawSpriteMatOverscan
;;
;;    Draws an sprite to overscan video memory (or to a screen buffer),  
;; making use of a given 256-bytes aligned mask table to create transparencies. 
;;
;; C Definition:
;;    void <cpct_drawSpriteMatOverscan> (const void* *psprite*, void* *pvideomem*, 
;;                                       <u8> *width*, <u8> *height*, 
...
;;    > call cpct_drawSpriteMatOverscan_asm
;;
;; Remarks:
...
dms_sprite_8bit_boundary_crossed:
   ...
   jp    dms_sprite_height_loop ;; [3] Jump to continue with next pixel line

next_bank_line:    
   ld    a, #0x60              ;; [2] Horizontal correction for Bank 2
   add   e                     ;; [1] Adjust Low byte
   ld    e, a                  ;; [1] Update E
   jp    nc, dms_sprite_height_loop ;; [3] Continue if no carry to H
   inc   d                     ;; [1] Increment D to sync bank address
   jp    dms_sprite_height_loop ;; [3] Continue drawing next line
