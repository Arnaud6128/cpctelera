...
;;
_cpct_get6Bits::
   ;; Recover parameters from the HL and DE with __sdcccall(1) convention
   ;; HL = Pointer to the array in memory
   ;; DE = Index of the group of 6 bits we want to get
  
   ex  de, hl        ;; [1] DE <-> HL
   ;; DE = Pointer to the array in memory
   ;; HL = Index of the group of 6 bits we want to get
