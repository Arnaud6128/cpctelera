...
;; ----------------------------------------------------------------
;;  Best      |  12 + (26 + 15W)H        | 88 + (104 + 60W)H
;;  Worst     |       Best + 4           |     Best + 16
;; ----------------------------------------------------------------
;;  W=2,H=16  |        908               |      3632
;;  W=4,H=32  |        2764              |     11056
;; ----------------------------------------------------------------
...
draw_loop_width :
   ...
   inc  de         ;; [2] Next bytes sprite
   inc  hl         ;; [2] Next bytes memory
   djnz  draw_loop_width ;; [2/3] If B != 0 continue to copy 
   
   dec__ixh           ;; [2] IXH-- One less iteration to complete Sprite Height 
