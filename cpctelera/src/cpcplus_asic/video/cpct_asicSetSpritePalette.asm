...
;;
;; Details:
;;  The index 0 of the palette is the border color, this index is also transparent colour of Harware Sprite.
;;  To change only border colour use the function *cpc_asicSetBorder*.
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ld   bc, #ASIC_PALETTE_SPRITE ;; [3] HL = Address of hardware sprites Palette

asicSetRgbLoop:   
   ld   a, (hl)                  ;; [2] A = Get Color value (rgb) from array
   inc  hl                       ;; [2] HL++, Point to the next RGB in the array
   ld   d, (hl)                  ;; [2] D = Get Color value (rgb) from array
   inc  hl                       ;; [2] HL++, Point to the next RGB in the array
