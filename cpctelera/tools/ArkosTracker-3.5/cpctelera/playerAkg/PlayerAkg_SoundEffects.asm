...
;       Adaptation pour CPCTelera by @Arnaud6128
...
;       Mixes the volume (soft/hard) into one.
        IFDEF PLY_AKG_SE_HardwareSounds
                PLY_AKG_SE_VolumeSoftOrHard = 1
        ENDIF
;       Mixes the retrig flags into one.
        ...
        IFDEF PLY_CFG_UseRetrig         ;Generic AT retrig.
                PLY_AKG_SE_Retrig = 1
        ENDIF
...
PLY_AKG_PlaySoundEffect:
        ...
        ex   (sp), hl     ;; SP <-> HL : HL (H Useless / L = Inverted volume)
        ld    b, l        ;; B = L = Inverted volume
PLY_AKG_PlaySoundEffect_asm:		
...
PLY_AKG_StopSoundEffectFromChannel_asm:
