        ...
        ;To test, compile (as low as #0), launch CP/M Box emulator with: PCW.exe @ <program start address> 80 81 82 83 Y <program load address> <exe file.bin>
...
Main_Player_Start:
        ...
        IFDEF PLY_AKG_Rom
                PLY_AKG_ROM_Buffer = #3f00                  ;Can be set anywhere.
        ENDIF
