...
CPCT_TOOLS_ARKOS_DIR=${CPCT_TOOLS_DIR}/ArkosTracker-3.5.1a
...
## Executable files
CPCT_ARKOS_AKS2BIN=${CPCT_TOOLS_ARKOS_DIR}/tools/SongToAkg.exe
...
CPCT_EXECUTABLE_FILES=("${CPCT_ARKOS_AKS2BIN}" "${CPCT_ZIPALIGN_LINUX32}"
