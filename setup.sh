...
CPCT_TOOLS_SDCC_DIR=${CPCT_TOOLS_DIR}/sdcc-4.6.0
CPCT_TOOLS_IMG2CPC_DIR=${CPCT_TOOLS_DIR}/img2cpc
CPCT_TOOLS_RGAS_DIR=${CPCT_TOOLS_DIR}/gfx/rgas-1.2.5
CPCT_TOOLS_ARKOS_DIR=${CPCT_TOOLS_DIR}/ArkosTracker-3
...
## Executable files
CPCT_ARKOS_SONG2AKG=${CPCT_TOOLS_ARKOS_DIR}/tools/SongToAkg.exe
CPCT_ARKOS_SONG2AKM=${CPCT_TOOLS_ARKOS_DIR}/tools/SongToAkm.exe
CPCT_ARKOS_SONG2FX=${CPCT_TOOLS_ARKOS_DIR}/tools/SongToSoundEffects.exe
...
CPCT_EXECUTABLE_FILES=("${CPCT_ARKOS_SONG2AKG}" "${CPCT_ARKOS_SONG2AKM}" "${CPCT_ARKOS_SONG2FX}" "${CPCT_ZIPALIGN_LINUX32}"
